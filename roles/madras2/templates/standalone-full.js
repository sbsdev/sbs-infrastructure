...
<server xmlns="urn:jboss:domain:2.1">
    ...
    <system-properties>
        <property name="production-path" value="{{ production_path }}"/>
        <property name="abacus-import-dir" value="{{ abacus_import_dir }}"/>
        <property name="abacus-export-dir" value="{{ abacus_export_dir }}"/>
        <property name="database-url" value="{{ database_url }}"/>
    </system-properties>
    <management>
        <security-realms>
